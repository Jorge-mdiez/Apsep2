...
def prediccionDeTiempoDeViaje(evento):
    ...
    return [prediccion,"Tiempo de viaje"]
...
# Codificar el id del camión
    ...
    return [prediccion,"Tiempo de entrega"]
...
def escribirEnKafka(prediccion):
    ...
    mensaje = {
        ...
        "tipo_de_prediccion":prediccion[1]
    } # DECIDIR EL FORMATO DE LOS MENSAJES CON LAS PREDICCIONES
